...
async function uploadDoctor() {
  ...
  const url =
    "https://postgresapp-e83cc2ceb04b.herokuapp.com/api/doctor/create";
  try {
    ...
    <UFormGroup>
      <div class="flex flex-col space-y-4">
        <div class="space-x-2.5 flex justify-between items-center">
          ...
          <USelectMenu
            v-model="selectedStartHH.lunes"
            :options="timeHH"
            placeholder="10"
            class="w-[4.5rem]"
          />
          <USelectMenu
            v-model="selectedStartMM.lunes"
            :options="timeMM"
            placeholder="00"
            class="w-[4.5rem]"
          />
          ...
          <USelectMenu
            v-model="selectedEndHH.lunes"
            :options="timeHH"
            placeholder="10"
            class="w-[4.5rem]"
          />
          <USelectMenu
            v-model="selectedEndMM.lunes"
            :options="timeMM"
            placeholder="00"
            class="w-[4.5rem]"
          />
        ...
        <div class="space-x-2.5 flex justify-start items-center">
          <UCheckbox
            v-model="isActive.martes"
            class="w-[7rem]"
            label="Martes"
          />
          <USelectMenu
            v-model="selectedStartHH.martes"
            :options="timeHH"
            placeholder="10"
            class="w-[4.5rem]"
          />
          <USelectMenu
            v-model="selectedStartMM.martes"
            :options="timeMM"
            placeholder="00"
            class="w-[4.5rem]"
          />
          <UDivider orientation="vertical" />
          <USelectMenu
            v-model="selectedEndHH.martes"
            :options="timeHH"
            placeholder="10"
            class="w-[4.5rem]"
          />
          <USelectMenu
            v-model="selectedEndMM.martes"
            :options="timeMM"
            placeholder="00"
            class="w-[4.5rem]"
          />
        ...
        <div class="space-x-2.5 flex justify-start items-center">
          <UCheckbox
            v-model="isActive.miercoles"
            class="w-[7rem]"
            label="Miercoles"
          />
          <USelectMenu
            v-model="selectedStartHH.miercoles"
            :options="timeHH"
            placeholder="10"
            class="w-[4.5rem]"
          />
          <USelectMenu
            v-model="selectedStartMM.miercoles"
            :options="timeMM"
            placeholder="10"
            class="w-[4.5rem]"
          />
          <UDivider orientation="vertical" />
          <USelectMenu
            v-model="selectedEndHH.miercoles"
            :options="timeHH"
            placeholder="10"
            class="w-[4.5rem]"
          />
          <USelectMenu
            v-model="selectedEndMM.miercoles"
            :options="timeMM"
            placeholder="00"
            class="w-[4.5rem]"
          />
        ...
        <div class="space-x-2.5 flex justify-start items-center">
          <UCheckbox
            v-model="isActive.jueves"
            class="w-[7rem]"
            label="Jueves"
          />
          <USelectMenu
            v-model="selectedStartHH.jueves"
            :options="timeHH"
            placeholder="10"
            class="w-[4.5rem]"
          />
          <USelectMenu
            v-model="selectedStartMM.jueves"
            :options="timeMM"
            placeholder="00"
            class="w-[4.5rem]"
          />
          <UDivider orientation="vertical" />
          <USelectMenu
            v-model="selectedEndHH.jueves"
            :options="timeHH"
            placeholder="10"
            class="w-[4.5rem]"
          />
          <USelectMenu
            v-model="selectedEndMM.jueves"
            :options="timeMM"
            placeholder="00"
            class="w-[4.5rem]"
          />
        ...
        <div class="space-x-2.5 flex justify-start items-center">
          <UCheckbox
            v-model="isActive.viernes"
            class="w-[7rem]"
            label="Viernes"
          />
          <USelectMenu
            v-model="selectedStartHH.viernes"
            :options="timeHH"
            placeholder="10"
            class="w-[4.5rem]"
          />
          <USelectMenu
            v-model="selectedStartMM.viernes"
            :options="timeMM"
            placeholder="00"
            class="w-[4.5rem]"
          />
          <UDivider orientation="vertical" />
          <USelectMenu
            v-model="selectedEndHH.viernes"
            :options="timeHH"
            placeholder="10"
            class="w-[4.5rem]"
          />
          <USelectMenu
            v-model="selectedEndMM.viernes"
            :options="timeMM"
            placeholder="00"
            class="w-[4.5rem]"
          />
